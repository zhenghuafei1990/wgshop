        ...
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="/admin/dologin" method="post">
                    ...
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" name="code" class="mws-login-password required" placeholder="请输入验证码" style="width:170px">
                            <img src="/admin/cap" onclick='this.src = this.src +="?1"'>
                        </div>
                    </div>
